...
bool StylerSelectorParser::parse(TokenList &tokens,
...
bool StylerSelectorParser::parseExtension(TokenList &tokens,
	TokenList::iterator &offset,
	StylerSelector &s) {
...
bool StylerSelectorParser::isArguments(TokenList &selector,
...
bool StylerSelectorParser::parseArguments(TokenList &selector,
	TokenList::iterator &offset,
	StylerSelector &s) {
	std::string delimiter = ",";
	TokenList::iterator it;
...
bool StylerSelectorParser::parseParameter(TokenList &selector,
	TokenList::iterator &it,
	Token &keyword,
	TokenList &value,
...
bool StylerSelectorParser::parseDefaultValue(TokenList &arguments,
	TokenList::iterator &it,
	const std::string &delimiter,
	TokenList &value) {
	unsigned int parentheses = 0;
...
bool StylerSelectorParser::parseConditions(TokenList &selector,
	TokenList::iterator &offset,
	StylerSelector &s) {
	TokenList condition;
	TokenList::iterator it = offset;
